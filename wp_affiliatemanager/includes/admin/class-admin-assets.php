			...
			wp_localize_script(
				...
				array(
					...
					'i18n'      => array(
						...
						'final_bunny_score' => __( 'Bunny Score obtenido:', 'wp-affiliatemanager' ),
						...
						'site_global_avg'  => __( 'Promedio Global:', 'wp-affiliatemanager' ),
						'collection_score' => __( 'Collection Score:', 'wp-affiliatemanager' ),
						'weighted_tag_score' => __( 'Weighted Tag Score:', 'wp-affiliatemanager' ),
						'log_weighted_tag_score' => __( 'Log Weighted Tag Score:', 'wp-affiliatemanager' ),
						'diff_collection_vs_global' => __( 'Diff Collection vs Global:', 'wp-affiliatemanager' ),
						'diff_weighted_vs_global' => __( 'Diff Weighted vs Global:', 'wp-affiliatemanager' ),
						'diff_log_vs_global' => __( 'Diff Log vs Global:', 'wp-affiliatemanager' ),
